...
import './JobsInBangalore.css';
import Modal from '../model/Modal';

function JobsInBangalore() {
  ...
  const allJobs = useMemo(() => [
    { id: 1, title: 'Software Engineer', company: 'Techie Ltd', location: 'Bangalore', salary: '₹7-12 Lakhs', department: 'Engineering', workMode: 'Remote' },
    { id: 2, title: 'Product Manager', company: 'Innovate Corp', location: 'Bangalore', salary: '₹8-15 Lakhs', department: 'Product', workMode: 'Hybrid' },
    { id: 3, title: 'Data Scientist', company: 'Analytics Inc', location: 'Bangalore', salary: '₹10-20 Lakhs', department: 'Data', workMode: 'Work from office' },
    { id: 4, title: 'Frontend Developer', company: 'CodeWorks Ltd', location: 'Bangalore', salary: '₹5-10 Lakhs', department: 'Engineering', workMode: 'Remote' },
  ...
  return (
    <div className="jobs-in-bangalore-container">
...
export default JobsInBangalore;
