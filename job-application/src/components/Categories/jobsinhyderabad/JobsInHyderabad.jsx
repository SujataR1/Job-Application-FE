...
import './JobsInHyderabad.css';
import Modal from '../model/Modal';

function JobsInHyderabad() {
  ...
  const allJobs = useMemo(() => [
    { id: 1, title: 'Software Engineer', company: 'XYZ Ltd', location: 'Hyderabad', salary: '₹7-12 Lakhs', department: 'Engineering', workMode: 'Remote' },
    { id: 2, title: 'Product Manager', company: 'ABC Corp', location: 'Hyderabad', salary: '₹8-15 Lakhs', department: 'Product', workMode: 'Hybrid' },
    { id: 3, title: 'Data Scientist', company: 'LMN Inc', location: 'Hyderabad', salary: '₹10-20 Lakhs', department: 'Data', workMode: 'Work from office' },
    { id: 4, title: 'Frontend Developer', company: 'JKL Ltd', location: 'Hyderabad', salary: '₹5-10 Lakhs', department: 'Engineering', workMode: 'Remote' },
  ...
  return (
    <div className="jobs-in-hyderabad-container">
...
export default JobsInHyderabad;
