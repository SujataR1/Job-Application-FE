...
function JobsInPune() {
  ...
  const allJobs = useMemo(() => [
    { id: 1, title: 'Software Engineer', company: 'XYZ Ltd', location: 'Pune', salary: '₹7-12 Lakhs', department: 'Engineering', workMode: 'Remote' },
  ...
  return (
    <div className="jobs-in-pune-container">
