...
import './JobsInDelhi.css';
import Modal from '../model/Modal';

function JobsInDelhi() {
  ...
  const allJobs = useMemo(() => [
    { id: 1, title: 'Software Engineer', company: 'XYZ Ltd', location: 'Delhi', salary: '₹7-12 Lakhs', department: 'Engineering', workMode: 'Remote' },
    { id: 2, title: 'Product Manager', company: 'ABC Corp', location: 'Delhi', salary: '₹8-15 Lakhs', department: 'Product', workMode: 'Hybrid' },
    { id: 3, title: 'Data Scientist', company: 'LMN Inc', location: 'Delhi', salary: '₹10-20 Lakhs', department: 'Data', workMode: 'Work from office' },
    { id: 4, title: 'Frontend Developer', company: 'JKL Ltd', location: 'Delhi', salary: '₹5-10 Lakhs', department: 'Engineering', workMode: 'Remote' },
  ...
  return (
    <div className="jobs-in-delhi-container">
