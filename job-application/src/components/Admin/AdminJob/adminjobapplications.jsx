...
import './adminjobapplications.css'; // Style the page (you can customize the styles as needed)
import AdminNavbar from '../Navbar/Navbar'; // This is the main navbar
import AdminSidenavbar from '../Sidenavbar/Sidenavbar'; // Sidebar for the admin
...
const AdminJobApplications = () => {
  ...
  return (
    <div className="home-page">
      {/* Only AdminNavbar should be rendered here */}
      <AdminNavbar />
