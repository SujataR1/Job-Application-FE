...
//                                             <li><Link to="/manpower-jobs" className="dropdown-item">Skilled Man Power Jobs</Link></li>
//                                         </ul>
//                                     </div>
...
//                                         <ul>
//                                             {/* Dropdown Items */}
//                                             <li><Link to="/jobs-in-delhi" className="dropdown-item">Jobs in Kolkata</Link></li>
...
//                         )}
//                     </div>
//                     <Link to="/company" className="text-white font-bold text-lg hover:text-teal-300">Companies</Link>
//                     <Link to="/service" className="text-white font-bold text-lg hover:text-teal-300">Services</Link>
//                 </nav>
